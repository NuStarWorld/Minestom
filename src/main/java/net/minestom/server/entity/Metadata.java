...
public final class Metadata {
    ...
    public static Entry<CopperGolemMeta.WeatherState> WeatherState(@NotNull CopperGolemMeta.WeatherState value) {
        return new MetadataImpl.EntryImpl<>(TYPE_WEATHER_STATE, value, CopperGolemMeta.WeatherState.NETWORK_TYPE);
    }

    public static Entry<CopperGolemMeta.State> CopperGolemState(@NotNull CopperGolemMeta.State value) {
